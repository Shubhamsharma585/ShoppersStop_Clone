...
const FireLogin = () => {
  ...
  return isloggedIn ? (
    ...
    <div className={styles.left}>
      ...
      {wrongpass && (
        <p className={styles.wrongpass}>Invalid Email or Password!</p>
      )}
      ...
      <p className={styles.forgot} onClick={PassReset}>
        Forgot password?
      </p>
      ...
      <div className={styles.social}>
        ...
        <div className={styles.social_cont} onClick={handleLogin}>
          <div className={styles.google}></div>
        </div>
      </div>

      <p>
        <span className={styles.havean1}>Create a new account?</span>{" "}
        <Link to={"/registration"} style={{ textDecoration: "none" }}>
          <span className={styles.havean2}>Sign Up</span>
        </Link>
      </p>

      <div className={styles.offer}>Sign up & get 10% off</div>
