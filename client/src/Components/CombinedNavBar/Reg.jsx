    ...
    <div className={styles.main}>
      <div className={styles.left}>
        ...
        <div className={styles.social}>
          ...
          <div className={styles.social_cont} onClick={googlesignup}>
            <div className={styles.google}></div>
          </div>
        </div>

        <p>
          <span className={styles.havean1}>Have an account?</span>{" "}
          <span className={styles.havean2} onClick={() => Openlogin()}>
            Sign In
          </span>
        </p>
        ...
        <p>
          <span className={styles.rights1}>By signing up you agree to our</span>{" "}
          <span className={styles.rights2}>Terms of service</span>{" "}
          <span className={styles.rights1}>&</span>{" "}
          <span className={styles.rights2}>Privacy Policy</span>
        </p>
      </div>
